        ...
        <div class="global-modal global-modal--form" style="max-width: 500px; max-height: 85vh; overflow-y: auto;">
            ...
            <form class="edit-profile-form" id="editProfileForm" style="width: 100%;">
                ...
                <?php if (in_array('gh_club', $user_roles)) : ?>
                    ...
                    <div class="form-group" style="margin-top: 15px;">
                        <label style="display: block; font-size: 13px; color: #999; margin-bottom: 10px; font-weight: 500;">Количество подготовленных спортсменов, воспитанных в клубе</label>
                        <div class="athletes-counts-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(100px, 1fr)); gap: 10px;">
                            <div>
                                <label style="display: block; font-size: 11px; color: #666; margin-bottom: 4px; font-weight: 500;">ЗМС</label>
                                <input type="number" min="0" name="gh_zms_count" class="form-input--pill" style="padding: 10px 15px; font-size: 14px;" value="<?php echo esc_attr(get_user_meta($user_id, 'gh_zms_count', true)); ?>">
                            </div>
                            <div>
                                <label style="display: block; font-size: 11px; color: #666; margin-bottom: 4px; font-weight: 500;">МСМК</label>
                                <input type="number" min="0" name="gh_msmk_count" class="form-input--pill" style="padding: 10px 15px; font-size: 14px;" value="<?php echo esc_attr(get_user_meta($user_id, 'gh_msmk_count', true)); ?>">
                            </div>
                            <div>
                                <label style="display: block; font-size: 11px; color: #666; margin-bottom: 4px; font-weight: 500;">МС</label>
                                <input type="number" min="0" name="gh_ms_count" class="form-input--pill" style="padding: 10px 15px; font-size: 14px;" value="<?php echo esc_attr(get_user_meta($user_id, 'gh_ms_count', true)); ?>">
                            </div>
                            <div>
                                <label style="display: block; font-size: 11px; color: #666; margin-bottom: 4px; font-weight: 500;">КМС</label>
                                <input type="number" min="0" name="gh_kms_count" class="form-input--pill" style="padding: 10px 15px; font-size: 14px;" value="<?php echo esc_attr(get_user_meta($user_id, 'gh_kms_count', true)); ?>">
                            </div>
                            <div>
                                <label style="display: block; font-size: 11px; color: #666; margin-bottom: 4px; font-weight: 500;">Разрядники</label>
                                <input type="number" min="0" name="gh_razryad_count" class="form-input--pill" style="padding: 10px 15px; font-size: 14px;" value="<?php echo esc_attr(get_user_meta($user_id, 'gh_razryad_count', true)); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group" style="margin-top: 15px;">
                    ...
                    <div class="profile-card" style="margin-bottom: 30px;">
                        ...
                        <div class="club-card-details-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px; padding: 10px 0;">
                            ...
                            <div class="detail-item" style="grid-column: 1 / -1; border-top: 1px solid #f2f2f2; border-bottom: 1px solid #f2f2f2; padding: 15px 0; margin: 5px 0;">
                                <span class="detail-label" style="display: block; font-size: 13px; color: #999; margin-bottom: 8px;">Подготовлено спортсменов, воспитанных в клубе</span>
